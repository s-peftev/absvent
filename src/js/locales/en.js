export default {
  translation: {
    ...
    index: {
      ...
      main: {
        directions: {
          name_1: 'Order a system for an apartment / house',
          name_2: 'Order a system for a restaurant',
        },
        about: {
        ...
        'project-types': {
          ...
          tab_home: {
            ...
            schema_1: {
              ...
              description: 'The air conditioning scheme of the centralized
              system together with ventilation provides a high level of
              comfortable climatic conditions, and all internal equipment
              can be placed within one non-residential premises, at the
              entrance to the house, which simplifies further maintenance.',
            },
            schema_2: {
              label: 'System with wall-mounted split systems',
              description: 'Air-conditioning with wall-mounted split systems
              together with ventilation satisfies the basic needs of maintaining
              climatic conditions. Indoor units are located on the walls of each
              of the rooms in which you want to adjust the temperature.',
            },
            schema_3: {
              label: 'System with duct-type split systems',
              description: 'Air conditioning of duct-type split systems together
              with ventilation copes well with maintaining comfortable conditions.
              Indoor units are installed one for each of the rooms in which you want
              to adjust the temperature, usually in the ceiling space of adjacent
